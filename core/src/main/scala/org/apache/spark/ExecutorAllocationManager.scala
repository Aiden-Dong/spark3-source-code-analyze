 ...
 * │                                                                             │
 * │  ┌─────────────────┐    ┌─────────────────┐    ┌─────────────────┐          │
 * │  │ ExecutorMonitor │    │   Listener      │    │  ScheduleTask   │          │
 * │  │                 │    │                 │    │                 │          │
 * │  │ 跟踪executor状态 │    │ 监听Spark事件    │    │ 每100ms执行一次  │          │
 * │  │ - 空闲时间       │    │ - 任务提交/完成  │    │ - 计算目标数量   │          │
 * │  │ - 缓存数据       │    │ - Stage开始/结束 │    │ - 添加/移除决策  │          │
 * │  │ - Shuffle文件   │     │ - Executor事件  │    │                 │         │
 * │  └─────────────────┘    └─────────────────┘    └─────────────────┘         │
 * │           │                       │                       │                │
 * │           └───────────────────────┼───────────────────────┘                │
 * │                                   │                                        │
 ...
 * │     │                                                                 │     │
 * │     │ 检查条件：                                                       │     │
 * │     │ ✓ 空闲时间 > executorIdleTimeout (无缓存)                         │     │
 * │     │ ✓ 空闲时间 > cachedExecutorIdleTimeout (有缓存)                   │     │
 * │     │ ✓ 没有正在执行的任务                                              │     │
 * │     │ ✓ 没有活跃的shuffle文件 (如果启用shuffleTracking)                  │     │
 * │     └─────────────────────────────────────────────────────────────────┘     │
 * │                                    │                                        │
 * │                                    ▼                                        │
 * │  2. 更新目标Executor数量                                                     │
 ...
 * │     │ 对每个ResourceProfile：                                          │     │
 * │     │ ┌─────────────────┐  ┌─────────────────┐  ┌─────────────────┐   │     │
 * │     │ │ 计算最大需求量    │  │ 当前目标 > 需求  │  │ 需要添加executor │   │     │
 * │     │ │ maxNeeded =     │  │ 减少目标数量     │  │ 指数增长策略      │   │     │
 * │     │ │ 运行任务 +       │  │                 │  │ 1→2→4→8→16...   │   │     │
 * │     │ │ 待处理任务       │  │                 │  │                 │   │     │
 * │     │ └─────────────────┘  └─────────────────┘  └─────────────────┘   │     │
 * │     └─────────────────────────────────────────────────────────────────┘     │
 ...
 * │  3. 执行添加/移除操作                                                         │
 * │     ┌─────────────────────────────────────────────────────────────────┐     │
 * │     │ client.requestTotalExecutors() / removeExecutors()              │     │
 * │     └─────────────────────────────────────────────────────────────────┘     │
 * └─────────────────────────────────────────────────────────────────────────────┘
 *                                      │
 *                                      ▼
 ...
 * │                                                                             │
 * │  ┌─────────────────┐    ┌─────────────────┐    ┌─────────────────┐          │
 * │  │   YARN Mode     │    │ Kubernetes Mode │    │ Standalone Mode │          │
 * │  │                 │    │                 │    │                 │          │
 * │  │ ApplicationMaster│   │ KubernetesClient│    │ StandaloneClient│          │
 * │  │ 管理Container   │     │ 管理Pod资源     │    │ 管理Worker节点   │           │
 * │  └─────────────────┘    └─────────────────┘    └─────────────────┘          │
 * └─────────────────────────────────────────────────────────────────────────────┘
 *
